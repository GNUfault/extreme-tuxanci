...
static void
drawScore(tux_t * tux_right, tux_t * tux_left)
{
...
static void
drawShotInfo(tux_t * tux, int x, int y)
{
   int i;
...
static void
drawGunInfo(tux_t * tux, int x, int y)
{
...
static void
drawBonusInfo(tux_t * tux, int x, int y)
{
...
static void
drawGrafBonus(tux_t * tux, int x, int y)
{
   int offset;
...
void
drawPanel(tux_t * tux_right, tux_t * tux_left)
{
