...
int
getValue(char *line, char *env, char *val, int len)
{
   char *offset_env;
...
char *
setValue(char *line, char *env, char *val)
{
   char *offset_env;
   char *offset_val_begin;
   char *offset_val_end;
...
int
getValueInConfigFile(textFile_t * textFile, char *env, char *val, int len)
{
   int i;
   char *line;
...
int
setValueInConfigFile(textFile_t * textFile, char *env, char *val)
{
   int i;
   char *line;
   char *ret;
